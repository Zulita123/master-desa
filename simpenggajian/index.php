    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
              ...
              <div class="nav-profile-text d-flex flex-column">
                ...
                <span class="text-secondary text-small">Penggajian</span>
              </div>
           ...
           <?php
              if($_SESSION['status']=="Admin"){
               $userinterface="";
                $laporan="";
                $pegawai="";
              }elseif($_SESSION['status']=="HRD"){
                $pegawai="";
                $userinterface="";
                $laporan="hidden";
              }else{
                $userinterface="hidden";
                $laporan="";
                $pegawai="hidden";
              }
            ?>            
          ...
          <li class="nav-item" <?php echo $pegawai;?>>
            <a class="nav-link" href="index.php?p=pegawai">
              <span class="menu-title">Pegawai</span>
              <i class="mdi mdi-account menu-icon"></i>
            </a>
          </li>
           <li class="nav-item" <?php echo $userinterface;?>>
            <a class="nav-link" href="index.php?p=penggajian">
              <span class="menu-title">Penggajian Pegawai</span>
              <i class="mdi mdi-account menu-icon"></i>
            </a>
          </li>
