...
<html>
<head>
	<title>Print Laporan Pertahun</title>
	<link rel="stylesheet" type="text/css" href="../css/style.css">
</head>
<body style="background-color: #fff;">
	<div class="judul-content">
	<h1 style="text-align: center;font-family: segoe ui;">Laporan Pertahun</h1>
</div>
<div class="isi-content">
	<form action="index.php?p=laporan_perthn" method="POST">
